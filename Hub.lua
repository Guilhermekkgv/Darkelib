...
function Library:Create(table)
    ...
    local themes = {
        Blue = {
            ...
            TabContainerBackground = Color3.fromRGB(25, 25, 25),
            ContainerBackground = Color3.fromRGB(28, 28, 28),
            TitleLine = Color3.fromRGB(60, 60, 60),
            TitleText = Color3.fromRGB(255, 255, 255),
            TabNameText = Color3.fromRGB(255, 255, 255),
            TabButtonBackground = Color3.fromRGB(25, 25, 25),
            ...
            DropdownListBackground = Color3.fromRGB(32, 32, 32),
            DropdownOptionBackground = Color3.fromRGB(32, 32, 32),
    ...
    title.Position = UDim2.fromOffset(36, 9)
