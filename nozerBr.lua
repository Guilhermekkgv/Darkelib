...
function Library:Create(table)
    ...
    local themes = {
        Blue = {
            ...
            TabContainerBackground = Color3.fromRGB(22, 22, 22),
            ContainerBackground = Color3.fromRGB(25, 25, 25),
            ...
            DropdownListBackground = Color3.fromRGB(28, 28, 28),
            DropdownOptionBackground = Color3.fromRGB(30, 30, 30),
